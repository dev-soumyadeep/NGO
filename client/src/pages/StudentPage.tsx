  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-brand-indigo mb-2">Student Management</h1>
          <p className="text-gray-600">
            Select a school to view and manage its students
          </p>
        </div>
          ...
          <div className="text-center py-12 bg-white rounded-lg shadow">
            ...
            <p className="mt-1 text-sm text-gray-500">
              {searchQuery.trim() !== ''
                ...
                : 'No schools available for student management.'}
            </p>
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredSchools.map((school) => (
              <Link key={school._id} to={`/students/${school._id}`} className="block">

  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto p-6 bg-white rounded shadow mt-8">
        <h1 className="text-3xl font-bold text-brand-indigo mb-6">
          Track Item Purchase of Students
        </h1>
        ...
        {!isSearched ? (
          <div className="text-gray-500 text-lg mt-8">
            Please enter a filter and press the search button.
          </div>
        ) : (
          <div>
                  ...
                  <tbody>
                    {history.map((row, idx) => (
                      <tr key={idx} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-2 border">
                          {getSchoolNameById(row.schoolId)}
                        </td>

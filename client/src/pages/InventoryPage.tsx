  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-brand-indigo mb-2">School Inventory Assignment</h1>
          <p className="text-gray-600">
            Select a school to view and manage its assigned inventory from the central stock.
          </p>
        </div>
          ...
          <div className="text-center py-12 bg-white rounded-lg shadow">
            ...
            <p className="mt-1 text-sm text-gray-500">
              {searchQuery.trim() !== ''
                ...
                : 'No schools available for inventory assignment.'}
            </p>
          </div>
        ) : (

      ...
      <div className="flex space-x-4 mb-4">
        <button
          className={`px-4 py-2 rounded ${
            tab === "add" ? "bg-brand-indigo text-white" : "bg-gray-200"
          }`}
          onClick={() => setTab("add")}
        >
          Add Item
        ...
        <button
          className={`px-4 py-2 rounded ${
            tab === "update" ? "bg-brand-indigo text-white" : "bg-gray-200"
          }`}
        ...
        <button
          className={`px-4 py-2 rounded ${
            tab === "send" ? "bg-brand-indigo text-white" : "bg-gray-200"
          }`}
          onClick={() => setTab("send")}
        >
          Send Items
      ...
      {tab === "add" ? (
        <div>
          ...
          <button
            ...
            className="bg-brand-indigo text-white px-4 py-2 rounded"
          >
            Add Item
          </button>
        </div>
        ...
        <div>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full border rounded p-2"
              max={
                items.find((i) => i.id === selectedSendItemId)?.quantity || 1
              }
            />
          </div>
          <div className="mb-4">
            ...
            <input
              type="number"
              value={
                items.find((i) => i.id === selectedSendItemId)?.price ?? ""
              }
              className="w-full border rounded p-2"
            />
          </div>
